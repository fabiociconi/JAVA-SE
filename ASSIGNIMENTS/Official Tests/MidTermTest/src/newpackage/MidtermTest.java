...
public class MidtermTest {
   ...
   public static void main(String[] args) {
      ...
      for (int i = 0; i < 3; i++) {
         ...
         /*
          * for ( Phone aPhone : array ) { System.out.println( aPhone );           *
          * if ( aPhone instanceof Mobile) aPhone.setBillingRate(i); else
          * aPhone.setBillingRate(i); //employee.setBaseSalary( 1.10 *
...
abstract class Phone {
   ...
   public abstract void setBillingRate(double rate);
...
class Mobile extends Phone {
   ...
   @Override
   public void setBillingRate(double rate) {
      //return rate*(1+0.02);
      this.billingRate = billingRate - (billingRate * 5 / 100);
   ...
   public String toString() {
      ...
      /*
       * return String.format("phone number%s", phoneNumber, "serial number%s",
       * serialNumber, "breand%s", brand, "rate%d", billingRate, "minutes",
       * minutes );
       */
